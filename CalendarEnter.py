...
class Ui_MainWindow(object):
    def openCalendar(self):
        #Open the actual calendar after user is created
    ...
    def createUser(self):
        ...
        self.ui.userName.setText(username) #Sets the username in the calendar
    ...
    def setupUi(self, MainWindow):
        ...
        self.quitButton = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.quitApplication())
        self.quitButton.setGeometry(QtCore.QRect(260, 460, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.quitButton.setFont(font)
        self.quitButton.setObjectName("quitButton")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.openCalendar())
